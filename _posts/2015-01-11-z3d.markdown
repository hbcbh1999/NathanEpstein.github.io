...
<div class="btn-group" role="group">
  <button id='b1' type="button" class="btn btn-default">Basic Example</button>
  <button id='b2' type="button" class="btn btn-default">Configured Example</button>
</div>
