...
The goal of this tutorial is to introduce <a href="https://github.com/rogerwang/node-webkit">Node Webkit</a> and demonstrate integration with <a href="https://angularjs.org/">AngularJS</a> by building a primitive desktop REPL application. It assumes no knowledge of Node Webkit but some familiarity with AngularJS is helpful.
...
If this were a web app, main.js would be front end javascript. However, because we are using Node Webkit, *we can execute Node.js commands in our controller*.
